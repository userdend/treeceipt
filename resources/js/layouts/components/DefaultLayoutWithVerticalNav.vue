  ...
  <VerticalNavLayout>
    ...
    <template #navbar="{ toggleVerticalOverlayNavActive }">
      <div class="d-flex h-100 align-center">
        ...
        <!-- 👉 Search -->
        <div
          class="d-flex align-center cursor-pointer mt-6"
        ...
        >
          <VSelect
            ...
            item-value="id"
            return-object
            :model-value="workspaceStore.currentWorkspace"
    ...
    <template #vertical-nav-header="{ toggleIsOverlayNavActive }">
      ...
      >
        ...
        <h1 class="font-weight-medium leading-normal text-xl text-uppercase">Treeceipt</h1>
      </RouterLink>
