...
Route::middleware(['web', 'auth'])->group(function () {
    ...
    Route::prefix('receipts')->group(function () {
        ...
        Route::delete('/data/{id}/force', [ReceiptController::class, 'forceDelete'])->name('receipt.data.force-delete');
    ...
    Route::prefix('workspaces')->group(function () {
        ...
        Route::delete('/data/{id}/force', [WorkspaceController::class, 'forceDelete'])->name('workspace.data.force-delete');
